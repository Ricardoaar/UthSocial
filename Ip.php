<?php
    ...
    //función que escribe la IP.txt del cliente en un archivo de texto
    function write_visita (){

        //Indicar ruta de archivo válida
        $archivo="IP.txt";

        //Si que quiere ignorar la propia IP.txt escribirla aquí, esto se podría automatizar
        $ip="mi.ip.";
    ...
    //Obtiene la info de la IP.txt del cliente desde geoplugin
